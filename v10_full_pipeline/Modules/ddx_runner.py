...
class DDxSystem:
    ...
    def run_full_diagnosis(self, callback: Optional[Callable] = None) -> Dict[str, Any]:
        """
        ...
        result = self.pipeline.run_full_pipeline(callback=callback)
    ...
    def run_quick_diagnosis(self, callback: Optional[Callable] = None) -> Dict[str, Any]:
        ...
        result = self.pipeline.run_quick_diagnosis(callback=callback)
        result['case'] = self.current_case
        self.last_result = result
