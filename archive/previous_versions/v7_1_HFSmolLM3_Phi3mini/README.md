This directory contains the **LDDx v7.1** modules

**Primary features of this version include:**

1. Updated parsing to be adaptable to different model outputs.
...
conservative_model:
  ...
  model_path: 'HuggingFaceTB/SmolLM3-3B'  #<-- The new model path
  memory_fraction: 0.35  # May need to adjust based on VRAM
  temperature: 0.1
  top_p: 0.7
  max_tokens: 1536
  max_model_len: 4096
